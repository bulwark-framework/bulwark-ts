...
| [runtime-plane.md](runtime-plane.md) | The runtime plane as five layers, one per exec plan 0002 to 0006: rubric core, resolver, activities, assess workflow, assessor review. Diagrams of the layers, one case end to end, and the resolver. | accepted, layers 0002 and 0003 implemented |
